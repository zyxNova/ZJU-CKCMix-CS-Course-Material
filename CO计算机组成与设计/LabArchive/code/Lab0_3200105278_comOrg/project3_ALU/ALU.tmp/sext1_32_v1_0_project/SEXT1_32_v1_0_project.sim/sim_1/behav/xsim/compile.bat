...
REM
REM Generated by Vivado on Wed Mar 02 14:21:33 +0800 2022
...
echo "xvlog --incr --relax -prj SEXT1_32_tb_vlog.prj"
call xvlog  --incr --relax -prj SEXT1_32_tb_vlog.prj -log xvlog.log
