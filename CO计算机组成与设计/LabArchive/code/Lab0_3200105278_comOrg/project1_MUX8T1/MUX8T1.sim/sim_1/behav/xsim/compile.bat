...
REM
REM Generated by Vivado on Sat Feb 26 15:42:37 +0800 2022
...
echo "xvlog --incr --relax -prj MUX8T1_tb_vlog.prj"
call xvlog  --incr --relax -prj MUX8T1_tb_vlog.prj -log xvlog.log
